...
import com.ufmt.entities.Terminal;
import com.ufmt.graficos.Spritesheet;
import com.ufmt.graficos.UI;
...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_F){
			if(player.isRuk) player.grab = true;
			else player.isInvisible = true;
		}
	...
	public void mousePressed(MouseEvent e) {
		if(e.getButton() == MouseEvent.BUTTON1){
			player.mouseLeftClick = true;
		}else if(e.getButton() == MouseEvent.BUTTON3){
			player.mouseRightClick = true;
		}
	}
