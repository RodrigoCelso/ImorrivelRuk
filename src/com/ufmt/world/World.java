...
import com.ufmt.entities.Enemy;
			...
			for(int xx = 0; xx < map.getWidth(); xx++){
				for(int yy = 0; yy < map.getHeight(); yy++){
					...
					if(pixelAtual == 0xFF000000){
						...
						Enemy e = new Enemy(xx*TILE_SIZE,yy*TILE_SIZE,TILE_SIZE,TILE_SIZE,2,0,null);
						Game.entities.add(e);
					}else if(pixelAtual == 0xFF57007F) {
						// Terminal
						tiles[xx + (yy * WIDTH)] = new WallTile(xx*TILE_SIZE,yy*TILE_SIZE,Tile.TILE_WALL);
						Terminal t = new Terminal(xx*TILE_SIZE,yy*TILE_SIZE,TILE_SIZE,TILE_SIZE);
						Game.terminals.add(t);
					}
				}
			}
		} catch (IOException e) {
